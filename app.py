...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///dtustakes.db').replace('postgres://', 'postgresql://')
...
def api_bet():
    ...
    if not draw_id or not bet_type or not amount or not pick:
